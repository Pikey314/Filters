...
public class AllTexts {
   ...
   //filtry dolnoprzepystowe
    ...
    public static String gauss2FilterText = "Filtr Gaussa2\n\nFiltr powodujący rozmycie obrazu macierzą gaussa 5x5\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String gauss3FilterText = "Filtr Gaussa3\n\nFiltr powodujący rozmycie obrazu macierzą gaussa 5x5\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String gauss4FilterText = "Filtr Gaussa4\n\nFiltr powodujący rozmycie obrazu macierzą gaussa 5x5\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String gauss5FilterText = "Filtr Gaussa5\n\nFiltr powodujący rozmycie obrazu macierzą gaussa 7x7\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String coneFilterText = "Filtr Stożkowy\n\nFiltr powodujący rozmycie obrazu macierzą stożkową\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String piramideFilterText = "Filtr Piramidowy\n\nFiltr powodujący rozmycie obrazu macierzą piramidową\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    public static String circleFilterText = "Filtr Kołowy\n\nFiltr powodujący rozmycie obrazu ignorując piksele na rogach\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
  
    //filtry górnoprzepustowe
    public static String removeAverageFilterText = "Filtr Usuwający Średnią\n\nFiltr powodujący wyostrzenie obrazu oraz wzmocnienie szumów\n\nWybierz moc wyostrzenia za pomocą suwaka\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    ...
    public static String northGradientFilterText = "Filtr Gradientowy Północny\n\nFiltr wykrywający krawędzie metodą gradientową zgdonie z kierunkiem podanym w nazwie\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    ...
    public static String strongEmbossingFilterText = "Filtr Uwypuklający Mocny\n\nFiltr powodujący uwypuklenie obrazu\n\nWybierz moc uwypuklenia za pomocą suwaka\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";    
    ...
    public static String lapVerticalFilterText = "Filtr Laplace'a pionowy\n\nFiltr wykrywający krawędzie w pionowych kierunkach\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    public static String lapHorizontalFilterText = "Filtr Laplace'a poziomy\n\nFiltr wykrywający krawędzie w poziomych kierunkach\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    ...
    public static String medianFilterText = "Filtr Medianowy\n\nFiltr eliminujący szumy bez efektu rozmycia\n\nWybierz moc za pomocą suwaka\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    public static String maximalFilterText = "Filtr Maksymalny\n\nFiltr powoduje efekt powiększania się obiektów\n\nWybierz moc za pomocą suwaka\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    ...
    public static String expositionFilterText = "Filtr Ekspozycyjny\n\nFiltr zmienia ekspozycję obrazu (podobnie jak w fotografii)\n\nZa pomocą suwaka wybierz współczynnik ekspozycji\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
    public static String gammaFilterText = "Filtr Korekcji Gamma\n\nFiltr usuwający zniekształcenia wprowadzane przez monitor/skaner itp.\n\nZa pomocą suwaka wybierz wartość współczynnika gamma (rekomendowane: 7 lub 22)\n\nWciśnij przycisk 'Zastosuj' aby zaobserwować zmiany";
